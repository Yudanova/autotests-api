...
@pytest.mark.flaky(reruns=3, reruns_delay=2) # Reruns are implemented at the flaky marking level
def test_reruns():
    assert random.choice([True, False]) # Random choice to demonstrate an unstable test
